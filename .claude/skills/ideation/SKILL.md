...
| `@frontend-developer-claude` | UX patterns, competitor UI analysis, accessibility research |
| `@backend-developer-claude` | Architecture patterns, technology choices, scalability research |
| `@tester-claude` | Testing best practices, edge cases from real-world failures |
