...
If the change benefits from external context (e.g., "add GDPR compliance requirements"), offer to research via `@ideation-ghcp` or web search. Never auto-include researched content without PM confirmation.
