...
- **Application names** - What application or service names appear in the journey? Default to names used in the your AI assistant responses doc (e.g., Acme CRM (example), Acme ERP (example)) unless PM provides alternatives.
...
| `<App1>`, `<App2>` | Application names | Acme CRM (example), Acme ERP (example) |
