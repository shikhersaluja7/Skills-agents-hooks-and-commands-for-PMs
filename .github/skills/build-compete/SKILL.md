...
Before drafting, you can invoke the `@ideation-ghcp` agent for deeper competitive intelligence. Ask the PM: `Want me to run deep research before drafting?` Only invoke if the PM says yes.
